...
void gauge(uint16_t coordinate_x, uint16_t coordinate_y, uint32_t color, uint16_t val)
{
  ...
  fillTriangle(oldX1+4, oldY1-4, oldX1-4, oldY1+4, oldX2, oldY2, COLOR_BG); // Erase old arrow
  fillCircle(oldbalx, oldbaly, 2, COLOR_BG);
