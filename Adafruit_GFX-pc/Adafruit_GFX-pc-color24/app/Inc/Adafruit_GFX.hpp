...
class Adafruit_GFX : public Print {
 ...
 public:
  ...
  virtual void writeFillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint32_t color);
  ...
  virtual void writeLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint32_t color);
  ...
  void
   ...
   drawRGBBitmap(int16_t x, int16_t y,
    ...
    setTextColor(uint32_t color, uint32_t bg),
...
class Adafruit_GFX_Button {
 ...
 public:
  ...
  void initButton(Adafruit_GFX *gfx, int16_t x, int16_t y,
   ...
   uint32_t textcolor, char *label, uint8_t textsize);
 ...
 private:
  Adafruit_GFX *_gfx;
  int16_t       _x1=0, _y1=0; // Coordinates of top-left corner
  uint16_t      _w=0, _h=0;
  uint8_t       _textsize=0;
  uint16_t      _outlinecolor=0, _fillcolor=0, _textcolor=0;
  char          _label[10];

  bool currstate=0, laststate=0;
};
...
class GFXcanvas8 : public Adafruit_GFX {
 public:
  ...
  void     drawPixel(int16_t x, int16_t y, uint32_t color),
           fillScreen(uint32_t color),
           writeFastHLine(int16_t x, int16_t y, int16_t w, uint32_t color);
